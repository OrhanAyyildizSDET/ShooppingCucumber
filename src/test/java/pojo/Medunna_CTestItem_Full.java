...
public class Medunna_CTestItem_Full {
    /*
    createdBy	string
    ...
    public Medunna_CTestItem_Full(String createdBy, String createdDate, String defaultValMax, String defaultValMin, String description, int id, String name, double price) {
