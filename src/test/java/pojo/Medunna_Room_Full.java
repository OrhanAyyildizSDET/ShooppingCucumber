...
public class Medunna_Room_Full {
/*
    {
        "createdBy": "string",
    ...
    public Medunna_Room_Full(String createdBy, String createdDate, String description, int id, double price, int roomNumber, String roomType, boolean status) {
